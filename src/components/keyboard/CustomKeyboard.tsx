      ...
      >
        <div className="p-2">
          ...
          <div className="grid grid-cols-12 gap-1">
            ...
            <button className="col-span-4 h-9 rounded bg-gray-300 text-center shadow-sm active:bg-gray-400">
              BS
            </button>
            ...
            <button className="col-span-4 h-9 rounded-xl bg-purple-300 text-center shadow-sm active:bg-purple-400">
              f(x)
            </button>
            ...
            <button className="col-span-4 row-span-2 h-21 rounded bg-gray-300 text-center shadow-sm active:bg-gray-400">
              ↵
            </button>
          </div>
        </div>
